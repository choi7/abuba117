...
public class API10 {
    static Request getRequest(String seq_user,String seq_kindergarden,String is_reply,String seq_kindergarden_class,String title,String content,byte[] files){
        String command="insertNotice";
