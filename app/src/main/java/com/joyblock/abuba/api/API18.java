...
public class API18 {
    static Request getRequest(String seq_user,String seq_kindergarden, String seq_kindergarden_class,String title,String content,String year,String month,String day,String c_survey_vote,byte[][]files,String[]vote_item){
        String command="insertSurvey";
