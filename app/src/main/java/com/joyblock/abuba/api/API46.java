...
public class API46 {
    static Request getRequest(String seq_user,String seq_kindergarden,String year,String month,String day,String type,String rice,String soup,
        ...
        String command="insertMenuManagement";
