...
public class API42 {
    static Request getRequest(String seq_schedule_management,String start_year,String start_month,String start_day,String end_year,String end_month,String end_day,
        ...
        String command="updateScheduleManagement";
        String url=API.url+command+".do";
        MultipartBody.Builder builder=new MultipartBody.Builder().setType(MultipartBody.FORM);
        builder.addFormDataPart("seq_schedule_management",seq_schedule_management);
