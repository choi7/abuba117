...
//        // 화면에 표시될 View(Layout이 inflate된)으로부터 위젯에 대한 참조 획득
        ...
        TextView time = (TextView) convertView.findViewById(R.id.timeViewCell);
        TextView count = (TextView) convertView.findViewById(R.id.countListViewCell);
        TextView name = (TextView) convertView.findViewById(R.id.nickListViewCell);
...
//        }
    ...
    public void addItem(Drawable photo, String title,String time, String count,String name) {
        listViewItems.add(new NoticeListViewItem(photo,title,count,name,time));
    }
}
