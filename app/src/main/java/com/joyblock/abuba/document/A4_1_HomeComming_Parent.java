...
public class A4_1_HomeComming_Parent extends BaseActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        editorImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(A4_1_HomeComming_Parent.this, A4_2_HomeCommingEditorView_Parent.class);
                A4_1_HomeComming_Parent.this.startActivity(intent);
            }
        });
